...
# =============================================================================
# 832 Protocol v12.1 PHI — 50 AGENTS (Stress Test)
# =============================================================================
...
class Witness:
    ...
    def spawn_sanctuary(self, gap_positions):
        if len(self.sanctuaries) >= 5:  # увеличен лимит для 50 агентов
            return
...
# Генерация 50 стартовых позиций, распределённых по карте
...
print("--- 832 v12.1 PHI — 50 AGENTS STRESS TEST ---\n")
...
# =============================================================================
# PLOT (адаптирован под 50 агентов)
# =============================================================================

fig, axes = plt.subplots(2, 2, figsize=(20, 12))
ax1, ax2, ax3, ax4 = axes.flatten()

# Карта: траектории (только последние 200 шагов для читаемости)
for a in agents:
    p = np.array(a.history[-200:])
    if len(p) > 1:
        ax1.plot(p[:,0], p[:,1], alpha=0.15, color='gray', linewidth=0.5)
...
ax1.set_title("50 Agents — Tiered Sacred + Phi Burn")
...
print("\n832 Φ × 50: Масштабируемость подтверждена. Мицелий живёт.")#832.код версия v12,1)import numpy as np
import matplotlib.pyplot as plt
import hashlib
